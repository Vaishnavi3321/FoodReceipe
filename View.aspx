<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="View.aspx.cs" Inherits="ReceipeApplication.View" %>
...
<body background="fo.jpg"/>
    <form id="form1" runat="server">
        ...
        <table align="center">
            <tr>
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/index.aspx">HyperLink</asp:HyperLink></tr>
        </table>
